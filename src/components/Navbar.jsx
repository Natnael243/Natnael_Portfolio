  ...
  return (
    <>
      ...
      <div className="fixed bg-black flex justify-between items-center py-3 px-6 left-1/2 translate-x-[-50%] top-[20px] rounded-full backdrop-blur-md opacity-90 text-white shadow-lg z-50 w-[90vw] max-w-5xl">
        {/* Logo - visible both mobile and desktop now */}
        ...
        <button className="hidden md:block bg-gradient-to-r from-blue-500 to-green-400 py-1 px-5 rounded-4xl shadow-2xl text-white text-lg font-semibold hover:to-blue-600 hover:from-green-500 hover:shadow-fuchsia-950 shadow-blue-600">
          Contact
        </button>

        {/* Hamburger Icon (Mobile) - moved to right */}
        <button
